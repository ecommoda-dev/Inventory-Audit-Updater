...
### الوضعان — وده أخطر قرار في القسم
...
- صفوف `full` **مش متحدّدة افتراضيًا**، ونافذة التأكيد بتقول عددها بالرقم.
- **الفهرس المقصوص بيقفل `full` بالكامل** — جرد شامل على فهرس ناقص ادّعاء مش جرد.
